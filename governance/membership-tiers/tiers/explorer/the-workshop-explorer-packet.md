---
description: Everything you need to know about The Community Workshop as a first timer
layout:
  width: wide
  title:
    visible: true
...
Our members come from different walks of life and financial capacities. Some pay for the resources they use at the same price, some lower, some higher, and some contribute through community projects, helping manage and sustain the workshop.&#x20;

We operate in a **"Give what you can, and take what you need"** model
...
You are expected to have a purpose for being at the workshop. Could be discussing an idea, meeting members, working on a project, asking a question or getting to know the community better.
{% endstep %}

{% step %}
### Respect People

Be aware of your surroundings, respect privacy and personal space. Be aware that people are generally trying to focus. But feel free to approach someone inside The Workshop when you need, everyone's nice!
{% endstep %}
