...
Follow these steps to join our community
...
Visit the workshop with purpose. Could be trying to see what the workshop is about, discussing an idea, meeting members, working on a project, asking a question or getting to know the community better.
{% endstep %}

{% step %}
### Respect People

Be aware of your surroundings, respect privacy and personal space. Be aware that people are generally trying to focus. But everyone's nice! feel free to approach someone inside The Workshop when you need.
{% endstep %}
