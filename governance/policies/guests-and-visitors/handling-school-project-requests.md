---
description: How do we handle visitors asking for help for their school projects?
---
...
```mermaid
flowchart TD
    A([Start]) --> B[<h2>Step 1: Observe </h2> Ask questions to see if they genuinely like to learn or build something]
    B --> C{They want to learn and build something?}
    C -->|Yes| D[<h2>Step 2: Support</h2> Understand goals, assess the idea, connect them with helpful people, suggest related projects, and support learning without doing it for them]
    C -->|No| E[<h2>Step 2.1: Influence</h2> Explain what The Workshop is for, inspire them to build and learn, show possibilities, and clarify that they must take ownership]
    E --> F{Do they genuinely want to learn and build now?}
    F -->|Yes| D
    F -->|No| G[<h2>Step 3: Redirect</h2> Explain that we are unable to help them in a way that does not align with our mission, and affirm support when they are ready to learn or build]

    N[Note: In no way we build their projects for them; we are here to help them learn and build it themselves]
```
...
<summary>Example questions you can ask them to know more</summary>
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h2><i class="fa-link">:link:</i></h2></td><td><h4>Connect with existing projects</h4></td><td>Check for existing community projects that might relate to their need, and see if they can become a contributor.</td><td><a href="https://innovationlabs.ph/projects">Community Projects</a></td><td></td><td><a href="https://www.innovationlabs.ph/projects">https://www.innovationlabs.ph/projects</a></td></tr><tr><td><h2><i class="fa-compass">:compass:</i></h2></td><td><h4>Welcome our new Explorer!</h4></td><td>This visitor is likely now an <code>Explorer</code>, share this guide with them so they know how to be become part of the community.</td><td><a data-mention href="https://app.gitbook.com/s/64iXsyuGmiAfRoWPjIw2/tiers/explorer/welcome-to-the-workshop">Welcome to The Workshop!</a></td><td><img src="../.gitbook/assets/image.png" alt="" data-size="original"></td><td><a href="https://app.gitbook.com/s/64iXsyuGmiAfRoWPjIw2/tiers/explorer/welcome-to-the-workshop">Welcome to The Workshop!</a></td></tr><tr><td><h2><i class="fa-shield-check">:shield-check:</i></h2></td><td><h4>Handling Guests and Explorers</h4></td><td>By accepting this guest, you are responsible for ensuring that The Workshop continuous to be safe for our people and resources. Read the guide.</td><td><a data-mention href="handling-guests-and-explorers.md">handling-guests-and-explorers.md</a></td><td></td><td></td></tr></tbody></table>
